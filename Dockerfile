...
RUN wget –quiet https://github.com/gajop/botrunner/archive/master.zip -o botrunner
...
WORKDIR AI/Skirmish
RUN wget –quiet https://www.dropbox.com/s/lsknymk0yyssx3m/ZKGBAI_0.4.7z?dl=1
RUN 7z x ZKGBAI_0.4.7z
RUN wget –quiet https://www.dropbox.com/s/0ae5wbevyubfmqp/CircuitAI_0_7_6_4.zip?dl=1
RUN unzip CircuitAI_0_7_6_4.zip
RUN wget –quiet https://dl.dropboxusercontent.com/u/19320633/zkai.7z
RUN 7z x zkai
WORKDIR ..
